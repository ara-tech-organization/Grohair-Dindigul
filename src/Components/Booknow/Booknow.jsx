      ...
      >
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Grid container spacing={2} ml={{ lg: 10, md: 10, sm: 4 }}>
            {/* Row 1 */}
            <Grid item xs={12} sm={6} lg={6} data-aos="fade-up" width={{ lg: 250, sm: 200 }}>
              <TextField
                fullWidth
                name="firstName"
                label="First Name"
            ...
            <Grid item xs={12} sm={6} lg={6} data-aos="fade-down" width={{ lg: 250, sm: 200 }}>
              <TextField
                fullWidth
                name="lastName"
                label="Last Name"
            ...
            <Grid item xs={12} sm={6} lg={6} data-aos="fade-up" width={{ lg: 250, sm: 200,xs: 200}}>
              <TextField
                select
