...
const Skinsection = () => {
  ...
  const left = isMdDown ? "50%" : "60%"; // Adjust based on your design
  ...
  return (
    <Box
      sx={{
        backgroundColor: "#fff",
        px: { xs: 2, sm: 2, md: 2, lg: 5 },
        ml: { sm: 1, md: 2, xs: 2,lg:5 },
        py: 5,
      }}
    >
      {/* Title */}
      <Typography
        ...
        ml={{ md: 12 ,lg:-5}}
      >
        SKIN    <Box component="span" color="#ff0000ff">
                TREATMENT
              </Box>
      </Typography>
        ...
        >
          ...
          >
            ...
            <Typography
              variant="h6"
              color="black"
              sx={{ maxWidth: { xs: "100%", md: 370, sm: "100%",lg:400 } }}
              mb={5}
            >
          ...
          >
            {treatments.map((treatment, i) => (
              <Paper
                key={i}
                sx={{
                  width:{lg:360,xs:240,sm:340,md:250},
