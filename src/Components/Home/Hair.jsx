          ...
          >
            {treatments.map((treatment, i) => (
              <Paper
                key={i}
                sx={{
                  width: { lg: 360, xs: 250, sm: 340, md: 220 },
                  height: isMdDown ? 380 : 450,
                  borderRadius: 4,
                  overflow: "hidden",
                  position: "absolute",
                  backgroundColor: "#fff",
                  color: "black",
                  ml: { lg: 20, xs: 20, sm: 35, md: 24 },
                  ...getCardStyle(i),
                }}
                elevation={10}
              >
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              fontFamily="Poppins"
              mb={3}
              fontSize={{ sm: "1.4rem", xs: "1.8rem", md: "1.2rem" }}
              width={{ xs: "100%", md: 400 }}
            >
            ...
            <Typography
              variant="h6"
              color="black"
              sx={{ maxWidth: { xs: "100%", md: 500, sm: "100%", lg: 470 } }}
              mb={5}
            >
